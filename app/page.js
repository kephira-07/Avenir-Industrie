...
import { 
ShoppingCart, Plane, Ship, X, CheckCircle, ArrowRight, Facebook, Instagram, 
  Menu, Search, FaWhatsapp , ArrowLeft, Truck, Send, 
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-100 leading-relaxed">
              Commandez nos produits, choisissez livraison <strong>avion</strong> ou <strong>bateau</strong> pour vos produit uniquement disponible sur commande, 
